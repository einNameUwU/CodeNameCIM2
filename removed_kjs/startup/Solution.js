StartupEvents.registry("fluid", (event) => {
	...
	function addSolutionFluid(name1, name2, tag, color1, color2) {
		...
		builder2.flowingTexture(`${global.namespace}:fluid/solution/flow`) = builder2.stillTexture(`${global.namespace}:fluid/solution/still`)
